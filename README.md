...
### `Altcha::createChallenge(ChallengeOptions $options): array`
...
- `payload array|string`: The solution payload to verify.
...
- `payload array|string`: The payload to verify (string or `ServerSignaturePayload` array).
- `hmacKey string`: The HMAC key used for verification.
